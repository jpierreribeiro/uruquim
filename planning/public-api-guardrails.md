...
instantiations, ~5 KiB measured) into binaries that never test. That is
forbidden: the recorder teardown MUST be registered lazily — a private
...
assert it", closing the WP3 READY_WITH_BLOCKER.
